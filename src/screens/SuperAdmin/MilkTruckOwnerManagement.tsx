...
import { View, Text, StyleSheet, ScrollView, Alert, TouchableOpacity, Image, Modal as RNModal } from 'react-native';
              ...
              <View style={styles.docItem}>
                ...
                {selectedOwnerDocs.documents.gstDocument && (
                  <View style={styles.pdfLink}>
                    ...
                    {/* In a real app, we'd add react-native-pdf or open in browser */}
                  </View>
                )}
              </View>
            </View>
